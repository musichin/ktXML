...
class DeserializerTest {
    ...
    fun testTagWithTextAndElement() {
        ...
        assertThat(element[0]).isInstanceOf(TextElement::class.java)
        assertThat(element[1]).isInstanceOf(Element::class.java)
        assertThat(element[2]).isInstanceOf(TextElement::class.java)
    }
    ...
    fun testTagAttributes() {
        ...
        assertThat(element.attributes).hasSize(1).contains(Attribute("myAttribute", "3"))
    }
}